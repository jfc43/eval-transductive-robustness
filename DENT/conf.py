...
# ----------------------------- Attack options ------------------------------ #
_C.ATTACK = CfgNode()
_C.ATTACK.TYPE = "GMSA-MIN"
_C.ATTACK.RANDOM = "private"
_C.ATTACK.ENSEMBLE_SIZE = 3
_C.ATTACK.SKIP_ATTACK = False
_C.ATTACK.REORDER = False
